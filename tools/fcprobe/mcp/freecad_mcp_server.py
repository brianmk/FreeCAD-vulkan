...
SPAWN_ENV = {
    ...
    # Platform plugin is overridable so the same server can drive an XWayland
    # session (FC_MCP_QPA_PLATFORM=xcb).  Native Wayland stays the default; use
    # xcb only for dev flows that need XWayland (e.g. RenderDoc capture).
    "QT_QPA_PLATFORM": os.environ.get("FC_MCP_QPA_PLATFORM", "wayland"),
