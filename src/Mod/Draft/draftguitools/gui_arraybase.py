...
# *                                                                         *
# ***************************************************************************
"""Provides the shared GUI command behaviour for the Draft array tools."""

## @package gui_arraybase
# \ingroup draftguitools
# \brief Provides the shared GUI command behaviour for the Draft array tools.
...
class _ArrayGuiCommandBase(gui_base.GuiCommandBase):
    """Shared behaviour for array commands that pick a center point.

    Subclasses set ``_name`` and ``_panelClass`` and provide their own
    ``GetResources`` so that the translatable strings stay literal.
    """
